...
<head>
    ...
    <title>DSA Load Test - Single Statement</title>
...
<body class="bg-gray-100 text-gray-800 min-h-screen flex flex-col">
    ...
    <main class="flex-grow container mx-auto px-6 py-12">
        <div class="bg-white p-8 rounded-lg shadow-xl max-w-xl mx-auto">
            <h1 class="text-3xl font-bold mb-8 text-center text-gray-700">Send Single Statement</h1>
            ...
            <form action="{{ route('fire-single') }}" method="post" class="space-y-6">
                @csrf
                <div>
                    <label for="limit" class="block text-sm font-medium text-gray-700 mb-1">Number of Single Statements to Send</label>
